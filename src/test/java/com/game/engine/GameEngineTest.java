 ...
 *
 * <p>These tests validate the correct implementation of: - Singleton Pattern (GameManager) -
 * Strategy Pattern (MoveStrategy implementations) - Observer Pattern (GameObserver implementations)
...
public class GameEngineTest {
  ...
  public void testRandomStrategyBehavior() {
    ...
    assertTrue(
        selfHealed || targetAttacked, "Random strategy should either heal self or attack target");
  }
  ...
  public void testObserverReceivesEvent() {
    ...
    assertTrue(
        display.getEvents().contains("Player attacked"),
  ...
  public void testMultipleObservers() {
    ...
    assertTrue(
        display1.getEvents().contains("Multi-observer test"),
        "First observer should receive event");
    assertTrue(
        display2.getEvents().contains("Multi-observer test"),
