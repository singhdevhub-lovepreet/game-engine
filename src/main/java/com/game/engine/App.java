 ...
 *
 * <p>This class demonstrates how to use the implemented design patterns. Students can run this to
 * see their implementation in action.
 */
public class App {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println(
          "❌ Implementation not complete yet. Please implement all required classes.");
